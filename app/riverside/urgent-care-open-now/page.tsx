export const metadata = {
  title: "Urgent Care Open Now in Riverside (24 Hour & Late Night Clinics)",
  description:
    "Find urgent care centers open now in Riverside. Browse locations, hours, and contact info for late-night and 24-hour urgent care clinics.",
};
