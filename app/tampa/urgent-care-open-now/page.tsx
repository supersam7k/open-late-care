export const metadata = {
  title: "Urgent Care Open Now in Tampa (24 Hour & Late Night Clinics)",
  description:
    "Find urgent care centers open now in Tampa. Browse locations, hours, and contact info for late-night and 24-hour urgent care clinics.",
};
