export const metadata = {
  title: "Urgent Care Open Now in San Diego (24 Hour & Late Night Clinics)",
  description:
    "Find urgent care centers open now in San Diego. Browse locations, hours, and contact info for late-night and 24-hour urgent care clinics.",
};
      ...
      <section className="border-b bg-white">
        <div className="mx-auto max-w-6xl px-4 py-10">
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
            Urgent Care Open Now in San Diego
          </h1>
