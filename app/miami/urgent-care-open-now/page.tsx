export const metadata = {
  title: "Urgent Care Open Now in Miami (24 Hour & Late Night Clinics)",
  description:
    "Find urgent care centers open now in Miami. Browse locations, hours, and contact info for late-night and 24-hour urgent care clinics.",
};
